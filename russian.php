...
$_lang["forgot.password.summary"] = "Забыли пароль? Напишите свою электронную почту ниже и нажмите кнопку \"Reminder password\".";
$_lang["reminder.button"] = "Вспомнить пароль";
